import { FormatRegistry, Type, type StringOptions } from '@sinclair/typebox';
...
FormatRegistry.Set('url', (value) => urlRegExp.test(value));

const T = Type as Omit<typeof Type, 'String'> & {
    String(
        options?: Omit<StringOptions, 'format'> & { format?: 'url' }
